        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${ctx}/users/toSettingPage" data-title="基本资料"
                           data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${ctx}/users/toPasswordPage" data-title="修改密码"
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if permissions?seq_contains("2010")>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                           data-tab-mpi="m-p-i-3" data-tab="customers/index" target="_self"><i
                    ...
                    <#if permissions?seq_contains("60")>
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                ...
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-11" data-tab="users/index" target="_self"><i
                                ...
                                <dd class="">
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-12" data-tab="roles/index" target="_self"><i
                                                class="fa fa-tachometer"></i><span
                                ...
                                <dd class="">
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd"
                                       data-tab-mpi="m-p-i-13" data-tab="modelus/index" target="_self"><i
                                                class="fa fa-tachometer"></i><span
